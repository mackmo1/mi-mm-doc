/**
 * API Route: /api/branches1/[id]
 * Handles GET (single), PATCH (update), and DELETE operations for branch level 1
 */
...
export async function GET(
  ...
  return proxyToBackend<Branch>({
    endpoint: `/branches1/${id}`,
    method: 'GET',
  });
}

/**
 * PATCH /api/branches1/[id]
